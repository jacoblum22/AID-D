...
if not OPENAI_API_KEY:
    raise ValueError("OPENAI_API_KEY environment variable is required. Set it in .env file or environment.")

OPENAI_MODEL = os.getenv("OPENAI_MODEL", "gpt-4o-mini")  # Default with override
OPENAI_MAX_TOKENS = int(os.getenv("OPENAI_MAX_TOKENS", "500"))
OPENAI_TEMPERATURE = float(os.getenv("OPENAI_TEMPERATURE", "0.1"))  # Low temperature for consistent planning decisions
